    ...
    socket.on('createGameSuccess', (data) => {
        ...
        <div class="form-control">
          <input
            ...
            value='https://emojireaction.navaneeth.gq/?join=${joinCode}'
            disabled
          />
...
function copyText(joinCode) {
    ...
    navigator.clipboard.writeText(
        `https://emojireaction.navaneeth.gq/?join=${joinCode}`
    )
}
    ...
    if (navigator.share) {
        try {
            await navigator.share({
                ...
                url: `https://emojireaction.navaneeth.gq/?join=${joinCode}`,
            })
